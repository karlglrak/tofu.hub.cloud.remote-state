...
This repository is intended to be used _before_ any other `karlglrak/tofu.*` repository. As it is the repository which sets up and configures the infrastructure for the backend, it has no backend _itself_ and, therefore, the state file is written locally.
